...
onDown: function (tile, pointer) {
	...
	this.player = this.game.add.sprite(this.game.world.centerX, this.game.world.centerY, 'terrain');
    this.player.scale.setTo(1);
	
    this.player.animations.add('flip', [0, 1, 2, 3, 4, 5, 6], 20, false);
    this.player.animations.play('flip');
...
**************************************************************************************
	...
	// Load sprite sheet
	terrainImage.addEventListener("load", onDown);
